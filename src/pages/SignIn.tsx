            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  className="appearance-none block w-full pl-10 pr-3 py-2 border border-navy-300 rounded-md placeholder-navy-400 focus:outline-none focus:ring-gold-500 focus:border-gold-500 sm:text-sm"
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="appearance-none block w-full pl-10 pr-10 py-2 border border-navy-300 rounded-md placeholder-navy-400 focus:outline-none focus:ring-gold-500 focus:border-gold-500 sm:text-sm"
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-navy-500">New to UNA Platform?</span>
              </div>
            </div>
            ...
            <div className="mt-6">
              <Link
                to="/signup"
                className="w-full flex justify-center py-2 px-4 border border-navy-300 rounded-md shadow-sm text-sm font-medium text-navy-700 bg-white hover:bg-navy-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gold-500"
              >
                Create new account
              </Link>
            </div>
