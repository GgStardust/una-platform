...
export const financialTools: AffiliatePartner[] = [
  ...
  },
  {
    ...
    affiliateId: 'MONDAY_UNA_PLATFORM',
    commission: '25%',
    features: ['Project management', 'Team collaboration', 'Automations', 'Integrations', 'Time tracking'],
    pros: ['Visual interface', 'Great for teams', 'Strong automations', 'Good integrations', 'Mobile app'],
    cons: ['Can be expensive', 'Learning curve', 'Complex for simple needs'],
    bestFor: 'UNAs that need visual project management with team collaboration',
    status: 'active',
    slug: 'monday-com'
  },
  {
    ...
    url: 'https://asana.com/',
    affiliateId: 'ASANA_UNA_PLATFORM',
    commission: '20%',
    features: ['Project management', 'Task tracking', 'Team collaboration', 'Timeline view', 'Integrations'],
    pros: ['User-friendly', 'Good free tier', 'Strong collaboration', 'Timeline features', 'Mobile app'],
    cons: ['Limited free features', 'Can be expensive', 'Basic reporting'],
    bestFor: 'UNAs that need simple project management with strong team collaboration',
    status: 'active',
    slug: 'asana'
  },
  {
    ...
    affiliateId: 'TRELLO_UNA_PLATFORM',
    commission: '15%',
    features: ['Kanban boards', 'Task management', 'Team collaboration', 'Integrations', 'Mobile app'],
    pros: ['Simple interface', 'Visual approach', 'Good free tier', 'Easy to use', 'Great for small teams'],
    cons: ['Limited features', 'Basic reporting', 'Not ideal for complex projects'],
    bestFor: 'UNAs that need simple, visual project management for small teams',
    status: 'active',
    slug: 'trello'
  },
  {
...
export const legalServices: AffiliatePartner[] = [
  ...
  },
  {
    ...
    affiliateId: 'INCFILE_UNA_PLATFORM',
    commission: '25%',
    features: ['Business formation', 'Registered agent', 'Compliance monitoring', 'Document filing', 'Business tools'],
    pros: ['Affordable formation', 'Registered agent service', 'Compliance alerts', 'Good customer service', 'Fast processing'],
    cons: ['Upselling tactics', 'Limited customization', 'Basic legal advice'],
    bestFor: 'UNAs that need business formation services with ongoing compliance support',
    status: 'active',
    slug: 'incfile'
  },
  {
    ...
    affiliateId: 'ZENBUSINESS_UNA_PLATFORM',
    commission: '22%',
    features: ['Business formation', 'Registered agent', 'Compliance monitoring', 'Business banking', 'Tax services'],
    pros: ['Comprehensive services', 'Good customer support', 'Compliance monitoring', 'Business tools', 'Transparent pricing'],
    cons: ['Can be expensive', 'Limited customization', 'Upselling'],
    bestFor: 'UNAs that want comprehensive business formation with ongoing support',
    status: 'active',
    slug: 'zenbusiness'
  },
  {
    ...
    category: 'legal',
    description: 'Registered agent and business formation services',
    url: 'https://www.northwestregisteredagent.com/',
    affiliateId: 'NORTHWEST_UNA_PLATFORM',
    commission: '20%',
    features: ['Registered agent', 'Business formation', 'Compliance monitoring', 'Document filing', 'Privacy protection'],
    pros: ['Privacy-focused', 'Good customer service', 'Compliance monitoring', 'Document management', 'Transparent pricing'],
    cons: ['Limited formation services', 'Higher fees', 'Basic website'],
    bestFor: 'UNAs that prioritize privacy and need reliable registered agent services',
    status: 'active',
