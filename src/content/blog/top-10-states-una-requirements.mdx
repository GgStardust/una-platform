...
schema: |
  {
    ...
    "@type": "HowTo",
    "name": "UNA Formation Requirements: Top 10 States Guide",
    "description": "Complete guide to forming Unincorporated Nonprofit Associations in the top 10 states by population",
    "image": "https://www.unaguide.com/blog/top-10-states.jpg",
    "author": {
      "@type": "Organization",
      "name": "UNA Platform"
    },
    ...
    "publisher": {
      ...
      "logo": {
        "@type": "ImageObject",
        "url": "https://www.unaguide.com/logo.png"
      }
    },
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.unaguide.com/blog/top-10-states-una-requirements"
    },
    "step": [
      {
        "@type": "HowToStep",
        "name": "Choose Your State",
        "text": "Select the best state for your UNA formation based on legal framework, costs, and operational needs"
      },
      {
        "@type": "HowToStep", 
        "name": "Understand Requirements",
        "text": "Learn the specific filing fees, annual reports, and compliance requirements for your chosen state"
      },
      {
        "@type": "HowToStep",
        "name": "File Required Documents",
        "text": "Complete state-specific filing requirements and establish your UNA"
      }
    ]
  }
---
...
For California-specific guidance, we recommend the excellent guide from the [Sustainable Economies Law Center (SELC)](https://www.theselc.org/how_to_be_an_unincorporated_association), which provides detailed information about UNA formation in California. Their guide complements this multi-state overview by offering in-depth California-specific requirements and considerations.

**Key Differences from SELC's Guide:**
- **SELC Focus**: California-specific formation and compliance
- **Our Focus**: Multi-state comparison and strategic state selection
- **Combined Value**: Use SELC's detailed California guide + our state comparison for comprehensive coverage
